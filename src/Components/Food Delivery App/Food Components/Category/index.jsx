  ...
  return (
    <div className="w-full h-[80vh]  flex  items-center justify-between bg-white flex-wrap">
      <div className=" h-full w-2/5 flex flex-col gap-12 px-6 py-16  ">
        <h1 className="text-5xl text-yellow-500 font-serif relative border-b-2 border-b-blue-500 pb-5 font-semibold">
          Our Category
        </h1>
        <img
          src={img}
          alt="forks"
          className="absolute w-16 rounded-full h-16 ml-[400px]  mt-[2.3rem]"
        />
