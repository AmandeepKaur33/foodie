...
// import img1 from "../../../Images/download (13).jpg";
...
//       img: img1,
//       name: "Micheal Fred",
//       message: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis, corporis voluptatem sequi repudiandae inventore nisi ad, alias perferendis explicabo fugit omnis? Esse, eveniet. Placeat, esse!",
//       time: "20/10/2023"
//     },
//     {
//       img: img1,
...
//   ]
//   return (
//     <div className='w-full h-[100vh] bg-white flex flex-col justify-evenly  items-center'>
//       <h1 className='text-5xl font-semibold'>What Our Customer Says</h1>
//       <div className='w-3/4 m-auto'></div>
//       <div className='mt-20 flex'>
//         {reviewList?.map((item)=>(
//           <ReviewCards itemList={item}/>
//         ))}
//       </div>
//       {/* <Swiper
//         style={{
