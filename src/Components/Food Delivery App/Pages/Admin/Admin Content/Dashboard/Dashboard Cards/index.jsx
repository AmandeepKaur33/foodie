...
const Card = ({ list }) => {
  ...
  return (
    <div className="w-11/12 sm:w-60 h-36 px-5 group group-hover:cursor-pointer mb-16 sm:mb-0 rounded-xl shadow-2xl bg-white relative">
      <div className="flex justify-between group-hover:cursor-pointer items-center w-full">
        ...
        <div className=" mt-3  ">
          <h1 className={` font-bold text-xl  `} style={{color: `${list.color}`}}>{list.title}</h1>
