...
const LoginFoodie = ({login,data,display,loginInp}) => {
  return (
    <form onSubmit={login} className='bg-white  rounded-lg flex items-center flex-col w-full  py-10 '>
        ...
        <div className='flex flex-col mb-3 gap-2 w-full pl-16 '>
                ...
                <input type='text' name='user' id='user' value={data.user} onChange={loginInp} className='border w-11/12 rounded-xl px-3 py-1 outline-none border-gray-500 focus:ring-blue-500' />
        </div>
        <div className='flex flex-col mb-3 gap-2 w-full pl-16 '>
                <label htmlFor='pass' className='text-xl font-medium'>Password</label>
                <input type='password' name='pass' id='pass' value={data.pass} onChange={loginInp} className='border w-11/12 rounded-xl px-3 py-1 outline-none border-gray-500 focus:ring-blue-500' />
        </div>
